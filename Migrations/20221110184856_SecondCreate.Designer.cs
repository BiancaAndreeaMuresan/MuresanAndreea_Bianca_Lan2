...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MuresanAndreea_Bianca_Lan2.Models.BookCategory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MuresanAndreea_Bianca_Lan2.Models.Category", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MuresanAndreea_Bianca_Lan2.Models.Book", b =>
                {
                    ...
                    b.HasOne("MuresanAndreea_Bianca_Lan2.Models.Category", null)
                        .WithMany("Books")
            ...
            modelBuilder.Entity("MuresanAndreea_Bianca_Lan2.Models.BookCategory", b =>
                {
                    b.HasOne("MuresanAndreea_Bianca_Lan2.Models.Book", "Book")
                        .WithMany("BookCategories")
                        .HasForeignKey("BookID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MuresanAndreea_Bianca_Lan2.Models.Category", "Category")
                        .WithMany("BookCategories")
                        .HasForeignKey("CategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
